...
async function UserProfile({ params }) {
    ...
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
        where: {
            id: parseInt(id)
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e12d4d04._.js.map