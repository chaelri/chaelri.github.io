...
const FEATURES = [
  ...
  ["...not swapped for anything", "js/screen.js", 'hasPower(a, "bazuka") && !ALL_POWERS[q.type]?.slotless'],
  ...
  ["...drawn as a field",    "js/render.js",  "a.shieldUntil && g.time < a.shieldUntil"],
  ["...in its own slot",     "js/sim.js",     'if (type === "kalasag") {'],
  ["Excalibur",              "js/config.js",  "espada: {"],
  ["...swung, and it slices", "js/screen.js", "function tickSwings"],
  ["...drawn as an arc",     "js/render.js",  "function drawSword"],
  ...
  ["...and on the card",     "js/panel.js",   'style="--f:${f}"'],
